...
class bgp_flow_spec_action_t {
    public:
        ...
        void set_community(std::string community) {
        ...
        std::string serialize() {
            ...
            } else if (this->action_type == FLOW_SPEC_ACTION_REDIRECT) {
                return "redirect " + rd + " community " + community + sentence_separator; 
            }
        } 
    private:
...
class exabgp_flow_spec_rule_t : public flow_spec_rule_t {
    public:
        ...
        std::string serialize_dscp() {
            return "dscp " + this->dscp + sentence_separator;
        }   

        std::string serialize_icmp() {
            return "icmp_type echo_request " + sentence_separator;
        }   
        ...
        std::string serialize_match() {
            ...
            // If we have ICMP
            if (find(this->protocols.begin(), this->protocols.end(), FLOW_SPEC_PROTOCOL_ICMP)
                != this->protocols.end() ) {
